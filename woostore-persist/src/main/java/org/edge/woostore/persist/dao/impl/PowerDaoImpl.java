 ...
 */
@Repository
public class PowerDaoImpl extends AbstractCoreDao<Power,String> implements IPowerDao {
    @Override
    ...
    @Override
    public int batchinsert(List<Power> records) {
        return 0;
    }
    ...
    @Override
    public Collection<Power> selectListByPrivilegeMaster(String privileMasterValue) {
        ...
        Collection<Power> privilegeCollection = getSession().createSQLQuery(sql).setParameter(0,privileMasterValue).list();
