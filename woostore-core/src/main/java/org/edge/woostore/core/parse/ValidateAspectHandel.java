...
import org.edge.woostore.domain.annotation.ValidateFiled;
import org.edge.woostore.domain.annotation.ValidateGroup;
...
public class ValidateAspectHandel {
    ...
    @Around("@annotation(org.edge.woostore.domain.annotation.ValidateGroup)")
